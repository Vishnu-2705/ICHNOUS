              ...
              >
                ...
                <motion.section variants={itemVariants} className="p-5 border-b border-border-subtle bg-bg-surface">
                  ...
                  <p className="text-xs text-text-primary leading-relaxed mb-3 font-sans">
                    Update the pricing rule condition to exclude enterprise tier from the 25% discount rule.
                  </p>

                  <div className="bg-[#18181B] text-[#F4F4F5] p-3 rounded border border-black/20 font-mono text-[11px] leading-relaxed overflow-x-auto">
                    <div className="text-emerald-400">if user.tier != 'enterprise':</div>
                    <div className="pl-4 text-blue-300">apply_discount(0.25)</div>
                    <div className="text-emerald-400">else:</div>
                    <div className="pl-4 text-blue-300">apply_discount(0.15)</div>
                  </div>
                </motion.section>

                {/* 6. SAFEGUARD */}
                <motion.section variants={itemVariants} className="p-5 bg-bg-surface flex-1 flex flex-col justify-between">
                  <div>
                    <div className="flex items-center gap-2 mb-2">
                    ...
                    <p className="text-xs text-text-primary leading-relaxed mb-4 font-sans">
                      Add a rule validation test for enterprise tier pricing and monitor discount anomalies.
                    </p>
                  </div>

                  <button className="w-full py-3 bg-[#10B981] hover:bg-[#059669] text-white font-display font-bold text-xs uppercase tracking-wider border-2 border-border-strong shadow-[4px_4px_0px_0px_#171717] hover:translate-y-[2px] hover:translate-x-[2px] hover:shadow-none transition-all cursor-pointer">
                    Generate Safeguard
                  </button>
                </motion.section>
              </motion.div>
